...
public class MainPageNewSonda extends Bazowa {
    ...
    public MainPageNewSonda(WebDriver driver) {
        PageFactory.initElements(driver, this);
    }

    public void utworzenieSondy() {
        nowaAnkietaButton.click();
    }

    public void nowaSonda() {
        Random ran = new Random();
        int nxt = ran.nextInt(999999);
        nazwaProjektu.sendKeys("Sonda: " + nxt);
    }
